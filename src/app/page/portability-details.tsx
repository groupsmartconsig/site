...
export function PortabilityDetails() {
  return (
    <div className="relative flex h-[780px] max-w-full w-full mx-auto flex-col items-center justify-center rounded-xl overflow-hidden pt-10 md:h-[720px] md:pt-0">
